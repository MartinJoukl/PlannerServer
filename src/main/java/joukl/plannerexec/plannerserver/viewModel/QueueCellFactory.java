        ...
        return new ListCell<>() {
            ...
            public void updateItem(Queue queue, boolean empty) {
                ...
                if (empty || queue == null) {
                    ...
                    setText("Name: " + queue.getName() + " ,capacity: " + queue.getCapacity() + ", priority: " + queue.getPriority() + ", agents: " + queue.getAgents().toString() + ", planningMode:" + queue.getPlanningMode().name());
                }
            }
        };
    }
